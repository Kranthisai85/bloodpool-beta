  ...
  Set<Marker> getmarkers() {
    ...
    setState(() {
      markers.add(Marker(
        ...
        position: LatLng(
           widget.userPosition != null ? widget.userPosition!.latitude +
                num.parse(doubleValue.toStringAsFixed(1)) / 150 : myLatPosition!.latitude +
                num.parse(doubleValue.toStringAsFixed(1)) / 150,
            widget.userPosition != null ? widget.userPosition!.longitude +
                num.parse(doubleValue.toStringAsFixed(1)) /
                    150 : myLatPosition!.longitude +
                num.parse(doubleValue.toStringAsFixed(1)) /
      ...
      markers.add(Marker(
        ...
        position: LatLng(
           widget.userPosition != null ? widget.userPosition!.latitude -
                num.parse(doubleValue.toStringAsFixed(1)) / 200 : myLatPosition!.latitude -
                num.parse(doubleValue.toStringAsFixed(1)) / 200,
            widget.userPosition != null ? widget.userPosition!.longitude -
                num.parse(doubleValue.toStringAsFixed(1)) /
                    200 : myLatPosition!.longitude -
                num.parse(doubleValue.toStringAsFixed(1)) /
      ...
      markers.add(Marker(
        ...
        position: LatLng(
           widget.userPosition != null ?  widget.userPosition!.latitude -
                num.parse(doubleValue.toStringAsFixed(1)) / 100 : myLatPosition!.latitude -
                num.parse(doubleValue.toStringAsFixed(1)) / 100,
           widget.userPosition != null ?  widget.userPosition!.longitude +
                num.parse(doubleValue.toStringAsFixed(1)) /
                    50 :myLatPosition!.longitude +
                num.parse(doubleValue.toStringAsFixed(1)) /
      ...
      markers.add(Marker(
        ...
        position: LatLng(
           widget.userPosition != null ?  widget.userPosition!.latitude -
                num.parse(doubleValue.toStringAsFixed(1)) / 220 : myLatPosition!.latitude -
                num.parse(doubleValue.toStringAsFixed(1)) / 200,
           widget.userPosition != null ?  widget.userPosition!.longitude -
                num.parse(doubleValue.toStringAsFixed(1)) /
                    80 : myLatPosition!.longitude -
                num.parse(doubleValue.toStringAsFixed(1)) /
      ...
      markers.add(Marker(
        ...
        position: LatLng(
           widget.userPosition != null ?  widget.userPosition!.latitude +
                num.parse(doubleValue.toStringAsFixed(1)) / 110 :  myLatPosition!.latitude +
                num.parse(doubleValue.toStringAsFixed(1)) / 100,
           widget.userPosition != null ?  widget.userPosition!.longitude +
                num.parse(doubleValue.toStringAsFixed(1)) /
                    90 : myLatPosition!.longitude +
                num.parse(doubleValue.toStringAsFixed(1)) /
